...
const Contacts: React.FC = () => {
	return (
		<div className={classes.ContactsMain}>
			<div className={classes.ContactsTitles}>
				<h1 className={classes.ContactsTitle}>Посмотреть код</h1>
				<h1 className={classes.ContactsTitle}>Пообщаться</h1>
			</div>
			<div className={classes.ContactsImages}>
